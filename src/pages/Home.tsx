    ...
    <main className="min-h-screen bg-linear-to-br from-slate-50 to-slate-100">
      <div className="container mx-auto px-5 py-16">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14 fade-in">
          <h1 className="text-5xl md:text-6xl font-bold mb-4.5 bg-linear-to-br from-[#2c4c71] via-[#446285] to-[#5cacfa] bg-clip-text text-transparent leading-tight">
            StoreAdmin Portal
          </h1>
        ...
        <div className="grid md:grid-cols-2 gap-7 max-w-5xl mx-auto mb-16">
          ...
          <div className="group bg-white rounded-[14px] p-8 shadow-md hover:shadow-xl border border-[#a5b8cc]/30 hover:border-[#5cacfa]/40 transition-all duration-300 hover:-translate-y-1 relative overflow-hidden">
            <div className="absolute top-0 right-0 w-32 h-32 bg-linear-to-br from-[#5cacfa]/10 to-transparent rounded-bl-full -mr-8 -mt-8"></div>
            <div className="relative">
              <div className="w-14 h-14 bg-linear-to-br from-[#2c8cfb] to-[#5cacfa] rounded-xl flex items-center justify-center mb-5 shadow-lg">
          ...
          {/* Catalogue Card */}
          <div className="group bg-white rounded-[14px] p-8 shadow-md hover:shadow-xl border border-[#a5b8cc]/30 hover:border-[#5cacfa]/40 transition-all duration-300 hover:-translate-y-1 relative overflow-hidden">
            <div className="absolute top-0 right-0 w-32 h-32 bg-linear-to-br from-[#446285]/10 to-transparent rounded-bl-full -mr-8 -mt-8"></div>
            <div className="relative">
              <div className="w-14 h-14 bg-linear-to-br from-[#446285] to-[#2c4c71] rounded-xl flex items-center justify-center mb-5 shadow-lg">
                <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-6xl mx-auto bg-white rounded-2xl p-12 shadow-lg border border-[#a5b8cc]/20">
          ...
          <div className="grid md:grid-cols-3 gap-9">
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-linear-to-br from-[#5cacfa]/20 to-[#2c8cfb]/10 rounded-xl flex items-center justify-center mx-auto mb-4 border border-[#5cacfa]/30">
